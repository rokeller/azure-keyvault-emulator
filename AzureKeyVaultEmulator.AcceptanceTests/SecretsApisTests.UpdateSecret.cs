...
partial class SecretsApisTests
{
    ...
    public async Task UpdateSecretWorks()
    {
        ...
        AssertInLastTwoSeconds(update1.Value.UpdatedOn);
        ...
        AssertInLastTwoSeconds(update2.Value.UpdatedOn);
        ...
        AssertInLastTwoSeconds(update3.Value.UpdatedOn);
        Assert.Equal("text/plain", update3.Value.ContentType);
        Assert.Null(update3.Value.Enabled);
        AssertInLastTwoSeconds(update3.Value.NotBefore);
        ...
        AssertInLastTwoSeconds(update4.Value.UpdatedOn);
        Assert.Equal("text/plain", update4.Value.ContentType);
        Assert.Null(update4.Value.Enabled);
        AssertInLastTwoSeconds(update4.Value.NotBefore);
